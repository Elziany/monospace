              ...
              <div class="d-flex justify-content-between flex-rows w-100">
                <div>
                  <img
                    ...
                    src="{{asset(auth()->guard('Provider')->user()->avatar)}}" class="bg-light dropdown-toggle drop-menu" type="button"
                ...
                <div>
                  ...
                  <ul id="dpm_prof" class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                    <li id="profile">
                      <a class="dropdown-item hide d-flex justify-content-start align-items-center fw-bold" href="{{route('providerProfile')}}">
                    ...
                    <li id="logout">
                      <a class="dropdown-item d-flex justify-content-start align-items-center fw-bold" href="{{route('providerLogout')}}">

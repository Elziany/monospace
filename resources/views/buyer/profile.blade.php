                        ...
                        <div class="row">
                            <div class="heada__page_title col-md-12 mrg--sm-hm clearfix pdn--an-imp dsp--b">
                                ...
                                <h1 class="heada__title col-md-8 col-xs-10 order-first " data-page-title="ملفي الشخصي">
                                    <span data-type="page-header-title"> My Profile</span>
                                </h1>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="carda__body widget__content">
                                            ...
                                            <div class="profile-card--avatar dsp--f ">
                                                <a href="" class="clr-gray-dark">
                                                    <img src="{{asset(auth()->guard('buyer')->user()->avatar)}}"
                                            ...
                                            <div class="profile-details">
                                                <h4 class="profile-name mrg--an">
                                                    <a
                                                        class="text-light">{{auth()->guard('buyer')->user()->name}}</a>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel panel-default mrg--bm " id="account-settings-panel">
                                        ...
                                        <div class="carda__body collapse in list-group " id="account-settings">
                                            ...
                                            <div class="list-group menu-list-group ">
                                                ...
                                                <div class="list-group-item brd--tn-imp active"> My profile
                                                </div>
                                                <div class="list-group-item text-light bg-dark rounded-bottom-3"> My
                                                    notifications
                                                </div>
                                            </div>
                                                ...
                                                <ul class="list-unstyled checklist  text-meta ">
                                                    <li class="">
                                                        <a>
                                                            ...
                                                            <span class="step text-light">Add skills </span>
                                                        </a>
                                                    </li>
                                                    <li class="">
                                                        <a>
                                                            ...
                                                            <span class="step text-light">Identity Virfication </span>
                                                        </a>
                                                    </li>
                                ...
                                <div class="col col-md-8">
                                    <div class="panel panel-default">
                                        <div class="carda__body carda__body_profile bg-dark text-light rounded-3">
                                            <form accept-charset="UTF-8" name="profile_form" id="profile_form"  action="{{route('createBuyerProfile')}}" method="POST">
                                                @csrf


                                                <div id="profile-fields" class="" style="position:relative;">
                                                    <div style="display: flex;justify-content: space-between;">
                                                    <input type="text" style="padding: 8px; outline: none;border: none; margin-bottom: 7px; " class="rounded-3" placeholder=" firest name" name="firstname">
                                                    <input type="text" style="padding: 8px; outline: none;border: none; margin-bottom: 7px; " class="rounded-3" placeholder=" seconde name" name="secondname">
                                                    </div>

                                                    <div class="form-group ">
                                                        <label for="account_type">Account type </label><em
                                                            class="clr-red">*</em>
                                                        ...
                                                        <div class="">
                                                            <div class="list-group-item brd--an pdn--vn rounded-3">
                                                                ...
                                                                <small style="margin-left: 15px;" class="text-muted">
                                                                    (search for freelancer to do my projects)
                                                                </small>
                                                    ...
                                                    <div class="row ">
                                                        <div class="col-sm-12 col-md-6">
                                                            <div class="form-group">
                                                                <label for="profile__title">Specialization</label><em
                                                                    class="clr-red">*</em>
                                                                <select class="form-control rounded-3"
                                                                    id="profile__speciality_id" name="specialization"
                                                                    data-ui="placeholder-select">
                                                                    <option ></option>
                                                                    <option> أعمال وخدمات استشارية</option>
                                                                    <option> برمجة، تطوير
                                                                        المواقع والتطبيقات</option>
                                                                    <option > هندسة، عمارة وتصميم داخلي
                                                                    </option>
                                                                    <option> تصميم، فيديو وصوتيات</option>
                                                                    <option> تسويق الكتروني ومبيعات</option>
                                                                    <option> كتابة، تحرير، ترجمة ولغات
                                                                    </option>
                                                                    <option> دعم، مساعدة وإدخال بيانات
                                                                    </option>
                                                                    <option> تدريب وتعليم عن بعد</option>
                                                                </select>
                                                                <p class="help-block text-zeta">Choose your industry
                                                                </p>
                                                        ...
                                                        <div class="col-sm-12 col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="tagsinput-container">
                                                                    ...
                                                                    <p class="help-block text-zeta">Enter one job title
                                                                    </p>
                                                    ...
                                                    <div class="form-group ">
                                                        <label for="profile__bio">bio Profile</label><em
                                                        class="clr-red">*</em>
                                                        <textarea placeholder="" id="profile__bio"
                                                            class="form-control rounded-3" rows="2" name="brief"
                                                            cols="50"></textarea>

                                                        <p class="help-block text-zeta">Add a brief introduction
                                                            introduce yourself
                                                            And your education, experience and skills.</p>
                                                    </div>

                                                    <div class="form-group  ">
                                                        <div class="clearfix">
                                                            <label for="skills" class="control-label">Skills</label><em
                                                            class="clr-red">*</em>
                                                        </div>
                                                        ...
                                                        <p class="help-block text-zeta">
                                                            Add skills related to your major.</p>
